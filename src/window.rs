use crate::{common::pack_rgb, wcstr};
...
pub fn create_popup_window() {
    ...
    unsafe {
        ...
        let window_class_name = wcstr!("Repulse_MainWindow");
        ...
        let window_title = wcstr!("Repulse Ransomware");
...
unsafe extern "system" fn window_proc(
    ...
    match msg {
        ...
        WM_PAINT => {
            ...
            let font_name = wcstr!("Segoe UI Semilight");
